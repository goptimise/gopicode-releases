...
try {
    ...
    replaceInFile('${{ github.workspace }}/gopicode-releases/.github/workflows/insiders-gp.yml', (object) => {
        object = object.replace("'upstream/main'", `'upstream/${branch}'`);
        object = object.replace("'gp-code/main'", `'gp-code/${branch}'`);
        return object;
    });
    replaceInFile('${{ github.workspace }}/gopicode-releases/.github/workflows/insiders.yml', (object) => {
        object = object.replace("'upstream/main'", `'upstream/${branch}'`);
...
if (branchExists) {
    replaceInFile('${{ github.workspace }}/gitpod/.github/workflows/code-nightly.yml', (object) =>
        object.replace(/https:\/\/api.github.com\/repos\/goptimise\/gopivcode-server\/commits\/gp-code\/release\/.{1,5}/i, 'https://api.github.com/repos/gitpod-io/openvscode-server/commits/gp-code/main'))
} else {
    replaceInFile('${{ github.workspace }}/gitpod/.github/workflows/code-nightly.yml', (object) =>
